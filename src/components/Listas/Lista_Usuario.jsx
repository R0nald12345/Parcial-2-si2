        ...
        <ul className="w-full flex gap-1 rounded-xl mb-3 bg-white shadow-xl">
          ...
          <li className="w-[25%] px-2">
            <div className='flex justify-around mt-2'>
                <button className='bg-green-700  hover:bg-green-900 rounded-xl text-white font-semibold px-2 cursor-pointer'>Agregar Facultad</button>

                <RiDeleteBin5Line className="text-3xl text-red-700 cursor-pointer"
