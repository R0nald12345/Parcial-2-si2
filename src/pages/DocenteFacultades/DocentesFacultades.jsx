...
import Encabezado_DocenteFacultades from '../../components/Encabezado_Listas/DocenteFacultades/Encabezado_DocenteFacultades,';

const DocenteFacultades = () => {
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <section className="w-[90%] flex-col justify-center p-2 mb-2">
          <div className="bg-white rounded-xl py-2">
            <h3 className="text-3xl text-center font-semibold">Listado de Docente Facultad</h3>
          </div>
        ...
        <Encabezado_DocenteFacultades/>
      </div>
    );
  };

export default DocenteFacultades