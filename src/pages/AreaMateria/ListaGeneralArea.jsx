...
import Encabezado_AreaMateria from '../../components/Encabezado_Listas/Encabezado_AreaMateria';

const ListaGeneralArea = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center">
        {/* Parte Superrior */}
        <section className="w-[55%] flex-col justify-center p-2 mb-2">
        ...
        <Encabezado_AreaMateria/>
                    
      </div>
    );
  };

export default ListaGeneralArea