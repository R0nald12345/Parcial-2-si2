...
import imagenFondo from "../components/ComponentsInitial/img/imagenLogin.jpg";

const LayoutAdmin = () => {
  return (
    // <div className='min-h-screen grid grid-cols-1 md:grid-cols-6 bg-slate-200'>
    <div
      className="min-h-screen grid grid-cols-1 xl:grid-cols-6 flex justify-center items-center bg-center bg-cover bg-blend-overlay"
