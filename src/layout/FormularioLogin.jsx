    ...
    <>
      <div className=' w-[80%] md:w-1/2 bg-white/50 block xl:flex justify-center rounded-lg mx-auto mt-32'>
        <form 
          ...
          <input 
            type='submit' 
            className='bg-red-600 hover:bg-red-700 text-white w-full font-semibold uppercase rounded-lg py-3 cursor-pointer'
          />
        </form>

        <div className='bg-red-600 xl:w-1/2 flex justify-center items-center px-10 rounded-lg rounded-tl-[100px] rounded-tr-[100px]  xl:rounded-tr-[0px] xl:rounded-bl-[100px] ' >
